...
// 	}
//
// 	// Make sure we process all the create events...
// 	time.Sleep(time.Millisecond * 800)
//
// 	stats := monitor.Stats(true)
//
// 	if stats.NumFilesCreated != 2 {
// 		t.Errorf("expected NumFilesCreated == 2, got %d", stats.NumFilesCreated)
// 	}
//
// 	if n := len(stats.NewFiles); n != 2 {
// 		t.Errorf("expected length of NewFiles == 2, got %d", n)
// 	}
//
...
// 	stats = monitor.Stats(true)
//
// 	if stats.NumFilesCreated != 1 {
// 		t.Errorf("expected NumFilesCreated == 1 after delete, got %d", stats.NumFilesCreated)
// 	}
//
// 	if n := len(stats.NewFiles); n != 1 {
// 		t.Errorf("expected length of NewFiles == 1 after delete, got %d", n)
// 	}
//
// 	// if slices.Contains(stats.NewFiles, testFile) {
